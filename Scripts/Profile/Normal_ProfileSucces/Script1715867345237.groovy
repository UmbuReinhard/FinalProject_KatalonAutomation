...
//--------------------------------Edit Nama Akun---------------------------------
WebUI.setText(findTestObject('Object Repository/ProfileUser/input__lastName'), 'Luffy D')
WebUI.click(findTestObject('Object Repository/ProfileUser/button_Simpan'))
WebUI.delay(2)
WebUI.takeScreenshot()

//---------------------------------Verify Allert Berhasil memperbarui profile------------------------------------------------

WebUI.verifyTextPresent('Berhasil memperbarui profil', true)
